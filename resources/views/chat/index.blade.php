...
<body>
    ...
    <div id="messages">
        @foreach ($messages as $message)
            <div class="message-container {{ $message->sender_id == Auth::id() ? 'sender' : 'receiver' }}">
        ...
        $(document).ready(function() {
            ...
            channel.bind('message', function(data) {
                if ((data.message.sender_id == {{ Auth::id() }} && data.message.receiver_id ==
                        {{ $user->id }}) || (data.message.sender_id == {{ $user->id }} && data
                        .message.receiver_id == {{ Auth::id() }})) {
                    var messageClass = data.message.sender_id == {{ Auth::id() }} ? 'sender' :
                        'receiver';
                    $('#messages').append('<div class="message-container ' + messageClass +
                        '"><div class="message-content"><strong>' + data.message.sender.name +
                        ':</strong> ' + data.message.message + '<br><span class="message-time">' + data
                        .message.created_at + '</span></div></div>');
                }
            });
